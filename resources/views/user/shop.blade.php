...
<div class="bg-shop h-full">
    ...
    <form class="max-w-xl mx-auto pt-32 px-4 mb-8 fade">
        ...
        <div class="relative">
            ...
            <form action="{{route('user.shop')}}">
                <input type="search" value="{{request('search')}}" id="default-search" name="search"
                    ...
                    placeholder="Search Pupuk, Maggot..." />
                <button type="text"
    ...
    <div class="grid ms-2 gap-x-4 gap-y-4 grid-cols-2 md:grid-cols-4 in ">
        ...
        @foreach ($produk as $p)
            <div class="h-64 w-48 sh  rounded-xl justify-self-center flex items-end"
                style="background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2)),url('/assets/pupukkasgot.jpg');  background-size: cover; background-position: center;">
                <div class="w-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <form action="{{route('shop.beli',$p->id)}}" method="POST">
                                            @csrf
                                        <button data-modal-hide="popup-modal-{{$p->id}}" type="submit"
                                        ...
                                        <button data-modal-hide="popup-modal-{{$p->id}}" type="button"
