              ...
              <form class="space-y-4 md:space-y-6" action="{{ route('editProfile') }}" method="POST">
                ...
                <input type="hidden" name="uid" value="{{ Auth::user()->id }}">
                  ...
                  <div>
                      ...
                      <input type="text" name="no_telp" id="no_telp" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="{{ Auth::user()->alamat}}" required value ="{{ Auth::user()->no_telp}}">
                  </div>
                  ...
                  <!-- lgender picker -->
                    <div>
                        ...
                        <input type="hidden" name="gender" id="gender" required placeholder="{{ Auth::user()->gender }}" value="{{ Auth::user()->gender }}">
