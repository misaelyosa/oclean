<nav id="navbar" class="navbar bg-white fixed dark:bg-gray-900 max-w-6xl mx-auto top-0 left-0 right-0 rounded-xl mt-2 border-2 border-gray-200 dark:border-gray-600 shadow-md">
  ...
  <ul class="mb-4 me-4 my-4 flex flex-col justify-center items-center font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-2 md:flex-row md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
    ...
    <li class="flex justify-center items-center">
      <a href="{{ route('user.sampah') }}" class = "{{ $title === 'sampah' ? 'text-green-700 dark:text-green-500' : 'text-gray-900 dark:text-gray-400' }} block py-1 px-2  text-center rounded hover:bg-green-700 hover:text-white md:hover:bg-transparent md:hover:text-green-700 dark:hover:bg-gray-700 md:dark:hover:text-green-500">
        Input Sampah
      </a>
    </li>
    <li class="flex justify-center items-center">
