    ...
    <div class=" flex flex-wrap items-center justify-between ">
        ...
        <div class="items-center justify-between hidden  md:flex " id="navbar-sticky">
            <ul
                ...
                <li class="flex justify-center items-center">
                    <a href=""
                        class="{{ $title === 'pickup' ? 'text-green-700 dark:text-green-500' : 'text-gray-900 dark:text-gray-400' }} block py-1 px-2  text-center rounded hover:bg-green-700 hover:text-white md:hover:bg-transparent md:hover:text-green-700 dark:hover:bg-gray-700 md:dark:hover:text-green-500">
                        Kirim
                    </a>
                </li>
