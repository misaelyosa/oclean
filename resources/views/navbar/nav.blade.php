...
<nav class="bg-white dark:bg-gray-900 fixed max-w-6xl mx-auto top-0 left-0 right-0 rounded-full mt-2 border-b border-2 dark:bg-gray-950 border-gray-200 dark:border-gray-600">
  ...
  <a href="" class="flex items-center space-x-2 rtl:space-x-reverse">
      ...
      <span class="self-center text-2xl text-center font-semibold whitespace-nowrap dark:text-white">Welcome,  !</span>
  </a>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul class="flex flex-col p-4  mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      ...
      <li>
        <a href="#" class="block py-2 px-3 {{$title === "shop" ? " rounded text-white md:text-green-700 hover:text-green-700  dark:text-gray-950   md:dark:text-green-500" : "text-gray-900 rounded hover:bg-green-700 md:hover:bg-transparent   dark:text-gray-950  md:hover:text-green-700 md:p-0 md:dark:hover:text-blue-500  dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"}}">Shop</a>
      </li>
      <li>
        <a href="#" class="block py-2 px-3 {{$title === "sampah" ? " rounded text-white md:text-green-700 hover:text-green-700  dark:text-gray-950   md:dark:text-green-500" : "text-gray-900 rounded hover:bg-green-700 md:hover:bg-transparent   dark:text-gray-950  md:hover:text-green-700 md:p-0 md:dark:hover:text-blue-500  dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"}}">Penjemputan Sampah</a>
      </li>
      <li>
        <a href="#" class="block py-2 px-3 {{$title === "customer" ? " rounded text-white md:text-green-700 hover:text-green-700  dark:text-gray-950   md:dark:text-green-500" : "text-gray-900 rounded hover:bg-green-700 md:hover:bg-transparent   dark:text-gray-950  md:hover:text-green-700 md:p-0 md:dark:hover:text-blue-500  dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"}}">Customer Service</a>
      </li>
      <li>
      @if (Auth::check())
